    ...
    <main className="flex min-h-screen flex-col items-center justify-center px-6 py-16">
        ...
        <form className="flex flex-col gap-5">
            ...
            <input 
                ...
                className="w-full rounded-xl border border-gray-300 bg-white px-4 py-3 text-sm text-gray-900 transition-colors focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500"
            />
            </div>
            ...
            <div>
                <label className="mb-1 block text-sm font-semibold text-gray-700">Medical Skills / Certifications</label>
                <input 
                type="text" 
                placeholder="e.g. CPR, First Aid, Elderly Care" 
                className="w-full rounded-xl border border-gray-300 bg-white px-4 py-3 text-sm text-gray-900 transition-colors focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500"
                />
            </div>
