        ...
        <main className="container mx-auto px-4 py-12 sm:px-6 md:px-10">
          <div className="mx-auto max-w-4xl">
            ...
            <div className="mx-auto max-w-lg">
              <Link to="/requests-incoming" className="group flex flex-col items-center justify-center rounded-3xl border-2 border-emerald-100 bg-white/80 p-12 text-center shadow-lg backdrop-blur-sm transition-all duration-200 hover:-translate-y-1 hover:border-emerald-300 hover:shadow-xl">
