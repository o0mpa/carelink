...
export function meta() {
    ...
    {
        name: "description",
        content: "Create an account to find trusted caregivers.",
    },
    ];
}
    ...
    <div className="min-h-screen bg-linear-to-br from-blue-100 via-white to-emerald-100 py-12">
        ...
        <div className="w-full max-w-4xl rounded-2xl bg-white/95 p-6 shadow-xl backdrop-blur-md ring-2 ring-gray-300 sm:p-10">
            ...
            <section>
                ...
                <div className="md:col-span-2">
                    <label className="mb-2 block text-sm font-bold text-gray-800 border-b pb-1">
                    Allergies
                    </label>
                    ...
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                      {/* Allergies */}
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <input 
                                type="text" 
                                name="otherAllergiesSpecify" 
                                disabled={isNoneSelected}
                                className="w-full rounded-md border-2 border-gray-300 bg-white px-2 py-1 text-sm text-gray-900 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100 disabled:cursor-not-allowed" 
                            />
                            </div>
                        </div>
                        </div>
            ...
            <button
                type="submit"
                className="mt-4 w-full rounded-xl bg-blue-600 px-4 py-4 text-lg font-bold text-white shadow-sm transition-all duration-200 hover:bg-blue-700 hover:shadow-md active:scale-[0.98]"
            >
