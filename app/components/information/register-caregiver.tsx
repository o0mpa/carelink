          ...
          >
            ...
            <section>
              ...
              <div className="rounded-xl border-2 border-gray-300 bg-white p-4">
                ...
                <div>
                  <label className="mb-1 block text-sm font-semibold text-gray-700">
                    Medical Specialties (Conditions/Disabilities Experienced
                    In):
                  </label>
                  <input
                    type="text"
            ...
            <section>
              ...
              <div className="grid grid-cols-1 gap-4 rounded-xl border-2 border-emerald-200 bg-emerald-50/30 p-4 md:grid-cols-3">
                ...
                <div>
                  <label className="mb-1 block text-xs font-semibold text-gray-700">
                    Caregiving / First Aid certificate
                  </label>
                  <input
                    type="file"
                    name="doc_certification"
                    required
                    className="max-w-full text-xs font-semibold text-gray-900 file:mr-2 file:cursor-pointer file:rounded-lg file:border-0 file:bg-emerald-100 file:px-3 file:py-1.5 file:text-xs file:font-semibold file:text-emerald-700 file:transition-colors file:hover:bg-emerald-200"
                  />
                </div>
              ...
              <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                <div>
                  ...
                  <div className="relative">
                    <span className="absolute left-3 top-2.5 font-semibold text-gray-500">
                      E£
                    </span>
                    <input
                      type="number"
            ...
            <button
              type="submit"
              className="mt-4 w-full rounded-xl bg-emerald-600 px-4 py-4 text-lg font-bold text-white shadow-sm transition-all duration-200 hover:bg-emerald-700 hover:shadow-md active:scale-[0.98]"
            >
              Submit Application
            </button>
          </Form>
