...
//         <span className="bg-linear-to-r from-blue-600 via-teal-500 to-emerald-500 bg-clip-text text-transparent drop-shadow-sm">
//           Welcome to CareLink
//         </span>
//       </h1>
...
export const Hero = () => {
  return (
    <main className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 pb-24 pt-16 text-center md:px-10">
      ...
      {/* 1. Add the CSS for the keyframe animation */}
      <style>{`
      ...
      <h1 className="text-5xl font-extrabold tracking-tight sm:text-6xl md:text-7xl">
        <span 
          className="
            ...
            bg-linear-to-r from-blue-600 via-teal-500 to-emerald-500 bg-clip-text text-transparent drop-shadow-sm
            
            /* 2. New classes to enable animation: */
            /* a. Increase background size so we can pan across it */
            bg-[length:300%_auto] 
            /* b. Apply the custom animation class defined above */
            animate-gradient-pan
            
            /* (Optional) Keeps the texture sharp while moving */
      ...
      <p className="mt-6 max-w-xl text-lg text-white-500 sm:text-xl leading-relaxed">
        Connecting families with trusted, verified caregivers — matched to your loved one's needs.
      </p>
