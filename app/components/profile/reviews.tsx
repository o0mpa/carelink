...
export default function ReviewPage() {
  ...
  if (submitted) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-200 via-amber-50 to-emerald-200 flex items-center justify-center px-6">
        {/* {USE_MOCK && (
        ...
        <div className="bg-white rounded-3xl shadow-xl p-10 max-w-md w-full text-center">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-[#1976D2] to-[#26C6DA] text-white py-3 rounded-xl font-bold hover:shadow-lg transition-all"
          >
            Back to Dashboard
          </button>
        </div>
  ...
  // ── FORM ──────────────────────────────────────────────────────────────────
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-200 via-amber-50 to-emerald-200">
      ...
      <main className="max-w-xl mx-auto px-2 py-4">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8">
          ...
          <div className="flex flex-col items-center mb-2">
            <span className="flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-amber-400 to-orange-500 shadow-md ring-1 ring-amber-200 mb-3">
          ...
          <button
            ...
            className={`w-full py-4 rounded-xl font-bold text-white text-base transition-all ${
              submitting
                ...
                : "bg-gradient-to-r from-amber-400 to-orange-500 hover:shadow-lg hover:scale-[1.01]"
            }`}
          >
