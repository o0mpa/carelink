...
export default function DashboardContact() {
  return (
    <div className="min-h-screen bg-linear-to-br from-teal-200 via-blue-200 to-emerald-200">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-blue-100/50 bg-linear-to-r from-blue-50/80 via-white/80 to-emerald-50/80 px-6 py-4 shadow-sm backdrop-blur-xl transition-all duration-300 md:px-10">
        <div className="mx-auto flex max-w-6xl items-center justify-between">
          ...
          <div className="flex flex-1 items-center justify-start">
            <Link
  to={getRole() === "Caregiver" ? "/dashboard/caregiver" : "/dashboard/client"}
  ...
  <span className="text-xl font-bold tracking-tight text-blue-900">
    CareLink
          ...
          <nav className="flex items-center justify-center">
            <span className="relative text-base font-semibold text-blue-800">
              Contact Us
      ...
      {/* Main Content */}
      <main className="container mx-auto px-6 py-2 md:px-10">
