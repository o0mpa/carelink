...
export function meta() {
  return [
    ...
    { name: "description", content: "Manage your professional caregiver profile, certifications, and availability." },
  ];
}

export default function CaregiverProfile() {
  const [activeTab, setActiveTab] = useState<"professional" | "experience">("professional");
  ...
  return (
          ...
          <div className="mb-6 flex flex-col items-center justify-between rounded-3xl bg-white/90 p-8 shadow-lg backdrop-blur-md ring-2 ring-blue-100 sm:flex-row sm:p-10">
            <div className="flex flex-col items-center gap-6 sm:flex-row sm:items-start">
              ...
              <div className="relative flex h-24 w-24 shrink-0 items-center justify-center rounded-full bg-emerald-600 text-3xl font-bold text-white shadow-md">
                <svg className="h-10 w-10 text-white/90" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
        </svg>
                {/* Profile upload*/}
                <Form method="post" encType="multipart/form-data">
                    <label className="absolute bottom-0 right-0 flex h-8 w-8 cursor-pointer items-center justify-center rounded-full bg-white text-teal-600 shadow-md ring-2 ring-blue-100 transition-colors hover:bg-gray-50 hover:text-blue-800" title="Upload Profile Picture">
              ...
              <div className="text-center sm:text-left">
                <h1 className="text-3xl font-extrabold text-slate-0 text-green-900">Your Name</h1>
                <p className="mt-1 text-sm font-medium text-gray-600">Certified Caregiver</p>
        ...
        <div className="rounded-3xl bg-white/90 p-8 shadow-xl backdrop-blur-md ring-2 ring-gray-300 sm:p-10">
            ...
            <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
                ...
                <div className="rounded-xl border-2 border-gray-100 bg-gray-50 p-4">
                    <p className="text-xs font-bold text-gray-500 uppercase tracking-wider">Contact Details</p>
                    <p className="mt-2 text-sm text-gray-900"><span className="font-semibold">Email:</span> email@example.com</p>
                    <p className="mt-1 text-sm text-gray-900"><span className="font-semibold">Phone:</span> phone number</p>
                    <p className="mt-1 text-sm text-gray-900"><span className="font-semibold">Age:</span> X </p>
                    <p className="mt-1 text-sm text-gray-900"><span className="font-semibold">Gender:</span> X </p>
                </div>
                <div className="rounded-xl border-2 border-gray-100 bg-gray-50 p-4 md:col-span-1">
                    <p className="text-xs font-bold text-gray-500 uppercase tracking-wider">Service Area</p>
                    <p className="mt-2 text-sm text-gray-900">Willing to travel within Dokki & Mohandseen</p>
                </div>
                </div>
    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        <div key={item.label} className="rounded-2xl border-2 border-gray-100 bg-white p-2 shadow-sm text-center">
            <p className="text-[10px] font-bold uppercase text-gray-700 mb-2">{item.label}</p>
    ...
    <section>
      ...
      <div className="rounded-2xl border-2 border-gray-100 bg-gray-50/50 p-6 sm:p-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
          {[
            "Physical care", "Medication management",  
            "Emotional support",
            "Health monitoring"
          ].map((skill) => (
        ...
        <div className="border-t border-gray-200 pt-3">
          <p className="text-xs font-bold uppercase tracking-wider text-gray-400 mb-2">Medical Specialties</p>
...
<section>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
    {[
      ...
      <div key={doc} className="flex items-center justify-between rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
        <div className="flex flex-col">
          <span className="text-[12px] font-bold uppercase text-gray-700">{doc}</span>
          <span className="text-xs font-semibold text-emerald-600">View File</span>
        </div>
