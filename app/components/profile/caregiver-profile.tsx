...
export async function loader() {
  return {
    caregiver: {
      ...
      age: 32,
      gender: "Female",
      serviceArea: "Willing to travel within Dokki & Mohandseen",
      salaries: [
      ...
      specialties: "Diabetic patient monitoring",
      documents: [
              ...
              <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
                ...
                <div className="mb-10 grid gap-6 md:grid-cols-2">
                  <div className="rounded-xl border-2 border-gray-100 bg-gray-50 p-4">
                    ...
                    <p className="mt-1 text-sm text-gray-900">
                      <span className="font-semibold">Phone:</span> {caregiver.phone}
                    </p>
                    <p className="mt-1 text-sm text-gray-900">
                      <span className="font-semibold">Age:</span> {caregiver.age}
                    </p>
                    <p className="mt-1 text-sm text-gray-900">
                      <span className="font-semibold">Gender:</span> {caregiver.gender}
                    </p>
                  </div>
                ...
                <section>
                  ...
                  <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
                    {caregiver.salaries.map((item: any) => (
                      <div
                        key={item.label}
              ...
              <div className="animate-in fade-in slide-in-from-bottom-2 space-y-12 duration-300">
                ...
                <section>
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    {caregiver.documents.map((doc: string) => (
                      <div
                        key={doc}
