...
export default function ChatInterface() {
  // Database-Ready State: Starts empty, waiting for backend to fetch messages.
  ...
  */
  ...
  return (
    // Darkened the base background slightly so white bubbles pop
                ...
                <div className={`flex max-w-[80%] flex-col gap-1.5 sm:max-w-[70%] ${isMe ? "items-end" : "items-start"}`}>
                  ...
                  <div 
                    className={`px-6 py-4 shadow-sm ${
                      isMe 
                        ? "rounded-[1.5rem] rounded-br-md bg-teal-600 text-white shadow-teal-600/20" 
                        : "rounded-[1.5rem] rounded-bl-md bg-white text-slate-900 ring-1 ring-slate-200/50"
                    }`}
                  >
