...
export default function PaymentResult() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-200 via-white to-emerald-200">
      ...
      <main className="max-w-2xl mx-auto px-10 py-2">
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-6">
          ...
          {status === 'success' && (
            <div className="text-center">
              ...
              <h2 className="text-3xl font-bold text-teal-800 mb-3">Payment Successful!</h2>
              <p className="text-slate-500 mb-8">Your payment has been processed successfully.</p>

              {/* transaction details */}
              {paymentDetails && (
                <div className="bg-slate-50 rounded-xl p-6 mb-3 text-left">
                  <h3 className="font-bold text-slate-700 mb-2 text-center">Transaction Details</h3>
              ...
              <div className="space-y-2">
                ...
                */}
                <button
                  type="button"
                  onClick={() =>
                    navigate(requestId ? `/chat/${requestId}` : "/dashboard/client")
                  }
                ...
                <button
                  onClick={() => navigate(`/reviews/${requestId}`)}
                  className="w-full bg-amber-50 border-2 border-orange-200 text-amber-200 py-4 font-bold text-white text-base rounded-xl bg-gradient-to-r from-orange-500 to-amber-300 hover:shadow-lg hover:scale-[1.01]"
                > 
                  Leave A Review
                </button>
              </div>
